...
Push Edits to Server: 
    ...
    5. If it is telling you that there is a conflict and you just want to make the code on the server exactly the same as the git repo then use command: "git reset --hard origin/main"
